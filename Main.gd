...
func reset_game() -> void:
	...
	computer_wickets = 0
	game_over = false
	player_batting = random_boolean()  # Randomly decide who starts batting
	is_player_turn = player_batting

	# Update UI to reflect reset state
	player_score_label.text = "Player Score: 0"
	computer_score_label.text = "Computer Score: 0"
	player_choice_label.text = "Player Choice: None"
	computer_choice_label.text = "Computer Choice: None"
